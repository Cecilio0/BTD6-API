...
public class TowerPutRequestHandler implements HandlerInterceptor {
	
	@Override
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
		String bodyString = request.getReader().lines().collect(Collectors.joining(System.lineSeparator()));
		TowerUpdateRequest tower = new ObjectMapper().readValue(bodyString, TowerUpdateRequest.class);
